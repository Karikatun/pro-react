module.exports = {
    ...
    rules: {
      ...
      'react/react-in-jsx-scope': 0, // предупреждает об отсутствии React при использовании JSX
      ...
      'react/jsx-props-no-spreading': 'warn', // разрешает о ...props
      quotes: [
        2,
        'single',
        'avoid-escape'
      ...
      ], // отключает предупреждения о расширении одного интерфейса без добавления дополнительных членов
      'import/no-extraneous-dependencies': 0, // отключает правило, запрещающее использование devDependencies в jest
      '@typescript-eslint/no-namespace': 0, // отключает правило, запрещающее использование namespace 
    ...
    ignorePatterns: ['babel.config.js', 'jest.config.js', 'webpack.config.js']
  };